pipeline {
    ...
    environment {
            ...
            PROFILE = 'local'
            AWS_CREDENTIAL_NAME = 'seoulit-aws-key'
            DEPLOY_CREDENTIAL_NAME = 'deploy-ssh-key'
            REGION="ap-northeast-2"
            ECR_PATH = '548238553254.dkr.ecr.ap-northeast-2.amazonaws.com'
            IMAGE_NAME = '548238553254.dkr.ecr.ap-northeast-2.amazonaws.com/board'
            DEPLOY_Host="13.125.146.242"
        }
    stages {
